...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Editar Tipo de Chamado</h1>

        <form method="post" action="?route=tipos_chamados/atualizar">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descricao" name="descricao"><?= htmlspecialchars($dados['descricao']) ?></textarea>
            </div>
