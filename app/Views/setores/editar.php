...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Editar Setor</h1>

        <form method="post" action="?route=setores/atualizar">
            ...
            <a href="?route=setores/listar" class="btn btn-secondary ms-2">Voltar para Lista</a>
        </form>
    </div>
